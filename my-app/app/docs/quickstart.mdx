...
<AccordionGroup>
  <Accordion icon="github" title="Clone your docs locally">
    ...
    [dashboard](https://dashboard.intelli.com). To clone the repository
  ...
  <Accordion icon="rectangle-terminal" title="Preview changes">
    ...
    [Intelli CLI](https://www.npmjs.com/package/intelli) to preview the
    documentation changes locally with this command: ``` npm i -g intelli ```
    2. Run the following command at the root of your documentation (where
    `mint.json` is): ``` intelli dev ```
  </Accordion>
</AccordionGroup>
...
<Accordion icon="message-bot" title="Install our Github app">
  ...
  your [dashboard](https://dashboard.intelli.com). Once the bot has been
...
<Accordion icon="rocket" title="Push your changes">
  ...
  update your docs through our [dashboard](https://dashboard.intelli.com).
</Accordion>
