...
description: 'Intelli gives you complete control over the look and feel of your documentation using the mint.json file'
icon: 'gear'
---

Every Intelli site needs a `mint.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://intelliconcierge.com/contact`
    </ResponseField>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "x": "https://x.com/intelli",
    "website": "https://intelliconcierge.com"
  }
  ```
