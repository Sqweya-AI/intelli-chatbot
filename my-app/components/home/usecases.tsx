...
export default function Usecases() {
  return (
    <div className="mt-20 grid grid-cols-1 gap-2 md:grid-cols-3 md:gap-4" >
      <CommunicationCard
        title="Whatsapp:"
        description="Businesses whose primary communication method is WhatsApp use Intelli to respond to customer inquiries, schedule messages and automate responses."
