...
export function DashComponent() {
  ...
  const DashboardMetric : React.FC<DashboardMetricProps> = ({ title, value, total, icon: Icon }) =>(
    <Card>
  ...
  const ChatbotCard: React.FC<ChatbotCardProps> = ({title, description, onClick: onclick }) => (
  ...
  return (
    <div className="flex">      
      ...
      Create customized assistants for your business&apos;s customer support.      </p>
      
      <div className="grid gap-4 md:grid-cols-4">
        <ChatbotCard
          title="Create Chatbot"
          description="Start building a new chatbot"
          onClick={handleClick}
        />
        {[...Array(3)].map((_, index) => (
